...
full2 = full[full["Market Capitalization size"] < 0] = 0

multiplots = px.scatter(full2, x="Market Capitalization size", y="Overall points", color=' Industry', facet_col=" Sector", facet_col_wrap=2, #height=3000,
