...
metriclist =['NCAV size', 'Enterprise Valuation points', 'Market Capitalization size', 'Market Capitalization points']
...
#valuepoints.update_xaxes(type="log", range=[np.log10(490000000000), np.log10(610000000000)])
